...
shopModule:addBuyableItem({'UH 100x'}, 2273, 5000, 30, 'ultimate healing rune')
shopModule:addBuyableItem({'magic wall'}, 2293, 3500, 30, 'magic wall rune')
shopModule:addBuyableItem({'destroy field'}, 2261, 450, 30, 'destroy field rune')
shopModule:addBuyableItem({'light magic missile'}, 2287, 400, 30, 'light magic missile rune')
shopModule:addBuyableItem({'heavy magic missile'}, 2311, 1200, 30, 'heavy magic missile rune')
shopModule:addBuyableItem({'great fireball'}, 2304, 1800, 30, 'great fireball rune')
shopModule:addBuyableItem({'explosion'}, 2313, 2500, 30, 'explosion rune')
shopModule:addBuyableItem({'sudden death'}, 2268, 3500, 30, 'sudden death rune')
shopModule:addBuyableItem({'paralyze'}, 2278, 7000, 30, 'paralyze rune')
shopModule:addBuyableItem({'animate dead'}, 2316, 3750, 30, 'animate dead rune')
shopModule:addBuyableItem({'convince creature'}, 2290, 800, 30, 'convince creature rune')
shopModule:addBuyableItem({'chameleon'}, 2291, 2100, 30, 'chameleon rune')
shopModule:addBuyableItem({'desintegrate'}, 2310, 800,  30, 'desintegreate rune')
