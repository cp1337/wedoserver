...
shopModule:addBuyableItem({'heavy magic missile'}, 2311, 65, 1, 'heavy magic missile rune')
...
shopModule:addBuyableItem({'paralyze'}, 2278, 200, 1, 'paralyze rune')
shopModule:addBuyableItem({'animate dead'}, 2316, 100, 1, 'animate dead rune')
